...
#
# Script generated by Vivado on Wed Jun 05 12:44:31 +0200 2024
# SW Build 3865809 on Sun May  7 15:05:29 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : Demodulator_over.sh
...
#
# Usage        : Demodulator_over.sh
#                Demodulator_over.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                Demodulator_over.sh [-reset_run]
#                Demodulator_over.sh [-reset_log]
#                Demodulator_over.sh [-help]
#
...
# script info
echo -e "Demodulator_over.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./Demodulator_over.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot Demodulator_over xil_defaultlib.Demodulator_over xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim Demodulator_over -key {Behavioral:sim_blockcorrection:Functional:Demodulator_over} -tclbatch cmd.tcl -protoinst "protoinst_files/block_correction.protoinst" -protoinst "protoinst_files/Demodulator_over.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb Demodulator_over.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./Demodulator_over.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: Demodulator_over.sh [-help]\n\
Usage: Demodulator_over.sh [-step]\n\
Usage: Demodulator_over.sh [-lib_map_path]\n\
Usage: Demodulator_over.sh [-reset_run]\n\
Usage: Demodulator_over.sh [-reset_log]\n\
Usage: Demodulator_over.sh [-keep_index]\n\
Usage: Demodulator_over.sh [-noclean_files]\n\n\
