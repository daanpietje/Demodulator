...
#
# Script generated by Vivado on Mon Jun 03 11:15:50 +0200 2024
...
simulate()
{
  xsim Demodulator_over -key {Behavioral:sim_blockcorrection:Functional:Demodulator_over} -tclbatch cmd.tcl -protoinst "protoinst_files/Demodulator_over.protoinst" -log simulate.log
}
