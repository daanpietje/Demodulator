...
#
# Script generated by Vivado on Wed May 22 09:58:25 +0200 2024
...
simulate()
{
  xsim Demodulator_over -key {Behavioral:sim_1:Functional:Demodulator_over} -tclbatch cmd.tcl -protoinst "protoinst_files/Demodulator_over.protoinst" -log simulate.log
}
