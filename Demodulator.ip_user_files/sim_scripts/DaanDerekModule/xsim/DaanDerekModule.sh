...
#
# Script generated by Vivado on Mon Jun 17 20:08:41 +0200 2024
# SW Build 3865809 on Sun May  7 15:05:29 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : DaanDerekModule.sh
...
#
# Usage        : DaanDerekModule.sh
#                DaanDerekModule.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                DaanDerekModule.sh [-reset_run]
#                DaanDerekModule.sh [-reset_log]
#                DaanDerekModule.sh [-help]
#
...
# script info
echo -e "DaanDerekModule.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./DaanDerekModule.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot DaanDerekModule xil_defaultlib.DaanDerekModule xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim DaanDerekModule -key {Behavioral:sim_blockcorrection:Functional:DaanDerekModule} -tclbatch cmd.tcl -protoinst "protoinst_files/DaanDerekModule.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb DaanDerekModule.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./DaanDerekModule.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: DaanDerekModule.sh [-help]\n\
Usage: DaanDerekModule.sh [-step]\n\
Usage: DaanDerekModule.sh [-lib_map_path]\n\
Usage: DaanDerekModule.sh [-reset_run]\n\
Usage: DaanDerekModule.sh [-reset_log]\n\
Usage: DaanDerekModule.sh [-keep_index]\n\
Usage: DaanDerekModule.sh [-noclean_files]\n\n\
