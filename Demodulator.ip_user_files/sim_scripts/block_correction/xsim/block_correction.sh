...
#
# Script generated by Vivado on Wed Jun 05 10:40:20 +0200 2024
# SW Build 3865809 on Sun May  7 15:05:29 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : block_correction.sh
...
#
# Usage        : block_correction.sh
#                block_correction.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                block_correction.sh [-reset_run]
#                block_correction.sh [-reset_log]
#                block_correction.sh [-help]
#
...
# script info
echo -e "block_correction.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./block_correction.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot block_correction xil_defaultlib.block_correction xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim block_correction -key {Behavioral:sim_blockcorrection:Functional:block_correction} -tclbatch cmd.tcl -protoinst "protoinst_files/block_correction.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb block_correction.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./block_correction.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: block_correction.sh [-help]\n\
Usage: block_correction.sh [-step]\n\
Usage: block_correction.sh [-lib_map_path]\n\
Usage: block_correction.sh [-reset_run]\n\
Usage: block_correction.sh [-reset_log]\n\
Usage: block_correction.sh [-keep_index]\n\
Usage: block_correction.sh [-noclean_files]\n\n\
