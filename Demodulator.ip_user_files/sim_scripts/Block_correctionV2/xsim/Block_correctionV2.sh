...
#
# Script generated by Vivado on Fri Jun 07 12:22:43 +0200 2024
# SW Build 3865809 on Sun May  7 15:05:29 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : Block_correctionV2.sh
...
#
# Usage        : Block_correctionV2.sh
#                Block_correctionV2.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                Block_correctionV2.sh [-reset_run]
#                Block_correctionV2.sh [-reset_log]
#                Block_correctionV2.sh [-help]
#
...
# script info
echo -e "Block_correctionV2.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./Block_correctionV2.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot Block_correctionV2 xil_defaultlib.Block_correctionV2 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim Block_correctionV2 -key {Behavioral:sim_blockcorrection:Functional:Block_correctionV2} -tclbatch cmd.tcl -protoinst "protoinst_files/Block_correctionV2.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb Block_correctionV2.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./Block_correctionV2.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: Block_correctionV2.sh [-help]\n\
Usage: Block_correctionV2.sh [-step]\n\
Usage: Block_correctionV2.sh [-lib_map_path]\n\
Usage: Block_correctionV2.sh [-reset_run]\n\
Usage: Block_correctionV2.sh [-reset_log]\n\
Usage: Block_correctionV2.sh [-keep_index]\n\
Usage: Block_correctionV2.sh [-noclean_files]\n\n\
