...
HD_PWD='D:/Users/daanv/Documents/GitHub/Demodulator/Demodulator.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Block_correctionV2_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Block_correctionV2_wrapper.tcl
